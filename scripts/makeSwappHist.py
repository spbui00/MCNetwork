...
# for fileNumber in [1]:
    ...
    ax.hist(distances, weights = swapps, bins=50, density = True, histtype = "step", color = "k", range = [0, 100])
    ...
    ax.hist(distances, weights = swapps, bins=50, density = True, histtype = "step", color = "k", range = [0, 100], log = True)
