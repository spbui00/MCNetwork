...
ax.plot(np.maximum.accumulate(optEnergy1[:minIterations]),"-",ms=1,color="darkred" ,label="genetic")
ax.plot(np.maximum.accumulate(optEnergy2[:minIterations]),"-",ms=1,color="darkblue",label="MC")
