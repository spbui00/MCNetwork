...
im1 = ax1.imshow(D0_Dd_fitness          , cmap = "gnuplot", vmin = vmin, vmax = vmax, extent = [ D1_bins[0], D1_bins[-1], D0_bins[-1], D0_bins[0]], aspect = "auto")
im2 = ax2.imshow(D0_Dd_fitness_seperated, cmap = "gnuplot", vmin = vmin, vmax = vmax, extent = [ D1_bins[0], D1_bins[-1], D0_bins[-1], D0_bins[0]], aspect = "auto")
...
im1 = ax1.imshow(D1_Dd_fitness          , cmap = "gnuplot", vmin = vmin, vmax = vmax, extent = [ D1_bins[0], D1_bins[-1], D0_bins[-1], D0_bins[0]], aspect = "auto")
im2 = ax2.imshow(D1_Dd_fitness_seperated, cmap = "gnuplot", vmin = vmin, vmax = vmax, extent = [ D1_bins[0], D1_bins[-1], D0_bins[-1], D0_bins[0]], aspect = "auto")
